...
@freeze_time("2021-06-16 09:30:00")
def test_recent_items_contain_only_items_last_modified_today():
    items = [
        Item(1, 'Done Yesterday', datetime(2021, 6, 15, 23, 59, 59), 'Done'),
        Item(2, 'Done Today', datetime(2021, 6, 16, 0, 0, 0), 'Done'),
        Item(3, 'Doing Today', datetime(2021, 6, 16, 9, 0, 0), 'Doing'),
    ]
...
def test_older_items_contain_only_items_last_modified_before_today():
    items = [
        Item(1, 'Done Yesterday', datetime(2021, 6, 15, 23, 59, 59), 'Done'),
        Item(2, 'Done Today', datetime(2021, 6, 16, 0, 0, 0), 'Done'),
        Item(3, 'Doing Yesterday', datetime(2021, 6, 15, 9, 0, 0), 'Doing'),
    ]
